...
function LoginFour() {
    ...
    return (
        <React.Fragment>
            ...
            {/* Opinion */}
            <Grid>
            <form style={{width:'100%' , margin:'10px'}}  autoComplete="off">
                <textarea onChange={(e)=>setOpinion(e.target.value)} value={opinion} className="font-yekan opacity"  id="" cols="30" rows="2">لطفا نظر خود را بنویسید ...</textarea>
