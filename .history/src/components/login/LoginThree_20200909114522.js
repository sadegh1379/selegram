...
function LoginThree(props) {
    ...
    return (
        ...
        <div style={{textAlign:'right' , paddingRight:'60px' , marginTop:'49px' }}>
                    <p  style={{textAlign:'right' ,  fontWeight:'bold' , fontFamily:'inherit ' , fontSize:'30px', color:'#404D66'}}>به سلگرام خوش آمدید!</p>
                    <p className="color-text" style={{fontSize:'16px'  ,fonr, lineHeight:'30px' , paddingLeft:'20px' , opacity:'0.5'}}>برای تکمیل پروفایل خود لطفا نام  و نام خانوادگی  خود را به فارسی وارد کنید</p>
         </div>
