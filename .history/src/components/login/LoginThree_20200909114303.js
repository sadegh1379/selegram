...
function LoginThree(props) {
    ...
    return (
        ...
        <div style={{textAlign:'right' , paddingRight:'60px' , marginTop:'49px' }}>
                    ...
                    <p className="color-text" style={{fontSize:'16px', line , paddingLeft:'20px' , opacity:'0.5'}}>برای تکمیل پروفایل خود لطفا نام  و نام خانوادگی  خود را به فارسی وارد کنید</p>
         </div>
